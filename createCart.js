  ...
  document.querySelector('#createTable').addEventListener('click', () => {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        sizeAndStock.innerHTML = '<tbody align="center"><tr><th>Size(US)</th><th>Stock</th></tr>' + rowsAndCols + '</tbody>'
      }
    })
  })
}
