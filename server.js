...
app.post('/newcaptcha', (req, res) => {
  let sitekey = req.body.sitekey
  console.log(sitekey)
  let childProc = require('child_process')
  childProc.exec('open -a "Google Chrome" "http://www.adidas.com/on/demandware.store/Sites-adidas-US-Site/en_US/Page-HeaderInfo/"' + sitekey)
})
